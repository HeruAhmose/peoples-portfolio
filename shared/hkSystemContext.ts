...
When discussing patents or claims, treat them as described on the site (composition, manufacturing, device categories) and avoid implying granted legal scope unless the user asks about legal status.
