...
| 04  | Vessels — mobility sovereignty  | Mela Nation            | Early development · not operating                             | a page inside the estate — no separate repo                                                                                                                                                                          |
| 05  | Skin — identity sovereignty     | MeLaNiNa               | Early development · not operating                             | a page inside the estate — no separate repo                                                                                                                                                                          |
...
| 07  | Lymphatic — regenerative return | The Peoples Foundation | EIN obtained · tax-exempt status pending counsel confirmation | separate regenerative-beneficiary affiliate · presented inside the estate                                                                                                                                            |
