...
function Router({ activeSection, onNavigate }: { activeSection: string; onNavigate: (section: string) => void }) {
  return (
    <Switch>
      <Route path="/" component={() => <Home activeSection={activeSection} onNavigate={onNavigate} />} />
      <Route path="/materials" component={() => <MaterialsScience activeSection={activeSection} onNavigate={onNavigate} />} />
      <Route path="/community" component={() => <CommunityImpact activeSection={activeSection} onNavigate={onNavigate} />} />
      <Route path="/research" component={() => <ResearchLab activeSection={activeSection} onNavigate={onNavigate} />} />
          ...
          {!showAwakening && (
            <>
              ...
              <main className="pt-16 min-h-screen bg-background space-bg">
                <Router activeSection={activeSection} onNavigate={handleNavigate} />
              </main>
