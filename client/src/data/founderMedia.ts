...
export const FOUNDER_MEDIA: readonly FounderMediaAsset[] = [
  {
    ...
    throughline: "The present frame anchors the archive: service, technical training, family, and founder systems converge here.",
  ...
  },
  {
    ...
    caption: "Kannapolis Young Authors recognition from the early school years.",
    throughline: "Creative expression appears early in the record, before athletics, service, and technology become visible chapters.",
  ...
  },
  {
    ...
    eyebrow: "KANNAPOLIS",
    title: "Student years",
    caption: "Archival school-library portrait from a Kannapolis newspaper feature.",
    throughline: "The archive shows a student identity taking shape alongside the athletic discipline that would soon become more visible.",
  ...
  },
  {
    ...
    caption: "Kannapolis football after the game: teammates, repetition, and shared pressure.",
    throughline: "Football trained execution under contact. Preparation mattered because the next decision arrived at full speed.",
  ...
  },
  {
    ...
    throughline: "The athletic lesson was not force alone; it was balance, continuation, and staying decisive when the path narrowed.",
  ...
  },
  {
    ...
    caption: "Friday Nights in K-Town lists Jonathan Peoples at No. 14 in a community Top 20 of prolific Kannapolis running backs.",
    throughline: "Local memory preserves the chapter beyond a stat line: performance becomes part of the place that formed it.",
  ...
  },
  {
    ...
    throughline: "A different program, the same requirement: individual ability had to resolve into collective execution.",
  ...
  },
  {
    ...
    throughline: "Forward motion became a practical habit: absorb resistance, retain control, and keep the objective in view.",
  ...
  },
  {
    ...
    throughline: "The portrait marks continuity across programs: a competitive identity carried forward, not restarted.",
  ...
  },
  {
    ...
    throughline: "Track compressed performance into timing: speed only counted when the exchange was precise.",
  ...
  },
  {
    ...
    throughline: "Acceleration, control, and finishing became measurable rather than abstract: the clock removed ambiguity.",
  ...
  },
  {
    ...
    throughline: "Service added a different standard of accountability: mission, team, structure, and responsibility beyond the individual.",
  ...
  },
  {
    ...
    caption: "Cropped archival yearbook page from the academy and service period.",
    throughline: "The formal portrait records entry into an institution where standards, systems, and duty were explicit.",
  ...
  },
  {
    ...
    throughline: "NPower formalized a deliberate technical transition, connecting service discipline to contemporary systems and cybersecurity work.",
  ...
  },
  {
    ...
    caption: "A graduation moment with peers and guests responding in the room.",
    throughline: "The transition was social as well as technical: learning, peers, mentors, and public accountability all became part of the next chapter.",
  ...
  },
  {
    ...
    throughline: "Partnership is not outside the founder story. It is part of the human context that gives the work consequence.",
  ...
  },
  {
    ...
    throughline: "The systems are meant to outlast the moment of invention. Family makes continuity, responsibility, and the future concrete.",
  ...
  },
  {
    ...
    throughline: "The archive shifts from achievement to continuity: the founder is one node inside a larger family story.",
  ...
  },
  {
    ...
    throughline: "The present chapter contains both systems building and life building. Neither needs to be reduced to the other.",
...
export const FOUNDER_MEDIA_CHAPTERS = [
  {
    ...
    description: "Early creative recognition and Kannapolis archives establish the first throughline: curiosity, language, place, and community before the technical work.",
  },
  {
    id: "football",
    label: "Football",
    signal: "PREPARATION → CONTACT → EXECUTION",
    description: "Football trained execution under pressure: preparation, trust, repetition, balance through contact, and forward motion when the path narrowed.",
  },
  {
    id: "track",
    label: "Track",
    signal: "ACCELERATION → TIMING → FINISH",
    description: "Track made performance measurable. Speed mattered, but so did exchange timing, control, and the ability to finish under a clock.",
  },
  {
    id: "navy",
    label: "Navy",
    signal: "SERVICE → STANDARD → MISSION",
    description: "Service added institutional discipline: accountability to a team, standards larger than the individual, and resilience inside a defined mission.",
  },
  {
    id: "present",
    label: "Founder Present",
    signal: "TRAINING → FAMILY → SYSTEMS",
    description: "NPower formalized the technology and cybersecurity transition; family and partnership keep the purpose human; the current founder systems turn accumulated discipline into infrastructure.",
  },
] as const;
