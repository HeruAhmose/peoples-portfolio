  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          The 7-step manufacturing process transforms raw hemp fibers into a
          sophisticated multi-modal transduction composite. Each step is
          carefully controlled to maintain the coupling geometry necessary for
          emergent system-level performance.
        </p>
      </motion.div>
    </motion.div>
  );
